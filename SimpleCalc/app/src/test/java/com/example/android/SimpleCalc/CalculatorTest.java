...
public class CalculatorTest {
    ...
    public void powFirstNegativeNumber() {
        assertThat(mCalculator.pow(-5d, 4d), is(equalTo(625d)));
        assertThat(mCalculator.pow(-5d, 3d), is(equalTo(-125d)));
    }
    ...
    @Test
    public void powNegZeroFirstNegSecondNumber() {
        double resultPow = mCalculator.pow(-0d, -4d);
        assertThat(resultPow, is(equalTo(Double.POSITIVE_INFINITY)));
    }
