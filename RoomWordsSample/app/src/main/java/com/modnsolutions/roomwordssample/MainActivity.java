...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // All the activity's interaction is with the WordViewModel only.
        ...
        // Attach helper to recycler view.
        helper.attachToRecyclerView(recyclerView);
    }

    /**
     * Get new word from NewWordActivity and save in Room database.
     *
     * @param requestCode
     * @param resultCode
     * @param data
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == NEW_WORD_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            Toast.makeText(getApplicationContext(), R.string.empty_not_saved, Toast.LENGTH_SHORT)
                    .show();
        }
    }
