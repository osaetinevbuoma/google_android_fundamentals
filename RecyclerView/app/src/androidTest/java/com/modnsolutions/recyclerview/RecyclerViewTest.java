...
public class RecyclerViewTest {
    ...
    public void clickRecyclerViewItem() {
        onView(withId(R.id.recyclerview)).perform(actionOnItemAtPosition(4, click()));
        onView(withText("Clicked! Word 4")).check(matches(isDisplayed()));
    }

    @Test
    public void scrollToPosition() {
        onView(withId(R.id.recyclerview)).perform(RecyclerViewActions.scrollToPosition(10));
        onView(withText("Word 10")).check(matches(isDisplayed()));
    }
}
